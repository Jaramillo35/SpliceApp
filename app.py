    ...
    with row1[2]:
        st.markdown(
            ...
            <div class="tool-card">
                ...
                <div class="tool-desc">
                    Step 1: Upload DTCR report from iSpeed or DTCR_Summary.csv generated by Chrome extension. 
    ...
    with row2[0]:
        with st.container(border=True):
            st.markdown(
                ...
                <div class="tool-desc">
                    Step 2: Upload the result from Step 1 DTCR Matching Report to enrich the SECR with DTCR numbers and Reason for Change details.
                </div>
