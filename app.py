    ...
    with row1[2]:
        st.markdown(
            ...
            <div class="tool-card">
                ...
                <div class="tool-desc">
                    Step 1: Upload DTCR report from iSpeed or DTCR_Summary.csv generated by Chrome extension.  Step 2: Upload DTx circuits report.  Step 3: Generate the DTCR matching report.
        ...
        st.markdown(
            ...
            <div class="tool-card">
                ...
                <div class="tool-desc">
                    ...
                    STEP 2: Upload result from STEP 1 DTCR Matching Report to enrich the SECR with DTCR numbers and Reason for Change details. 
                </div>
