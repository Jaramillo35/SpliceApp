...
from secrdb.core.common.text import extract_bulletin_number as _canonical_extract_bulletin_number
from secrdb.core.common.validation import ensure_non_empty_upload, require_columns
from secrdb.core.dtcr import match_dtcr_to_harness_family as _canonical_match_dtcr_to_harness_family
...
def extract_bulletin_number(text: object) -> str:
    ...
    :mod:`secrdb.core.common.text`. Unlike the previous version here, a bare token
...
def match_dtcr_to_harness_family(dtcr_df: pd.DataFrame, dtx_df: pd.DataFrame) -> pd.DataFrame:
    ...
    Delegates to the single canonical implementation in :mod:`secrdb.core.dtcr`.
    ...
    * uses strict bulletin extraction (see :func:`extract_bulletin_number`).
    ...
    See :func:`secrdb.core.dtcr.matching.match_dtcr_to_harness_family` for details.
    """
