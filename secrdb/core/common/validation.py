...
:mod:`secrdb.core.common.errors` types so callers get uniform, actionable messages.
"""
...
from secrdb.core.common.errors import SpliceInputError, SpliceSchemaError
